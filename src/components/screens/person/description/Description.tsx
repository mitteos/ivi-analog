  ...
  return (
    ...
    >
      ...
      <div className="mt-4 text-[#d9d7e0]">
        <p
          ref={textRef}
          className="w-[90%] text-ellipsis line-clamp-2 opacity-70"
        >
          Скарлетт Йоханссон (Scarlett Johansson) – американская киноактриса,
          получившая массовую популярность после фильмов «Трудности перевода»,
          «Еще одна из рода Болейн», «Мстители».
        </p>
        <button

...
export const Details: React.FC<{}> = () => {
  ...
  return (
      <div>
        <p className='text-gray-400 text-[14px] mb-1'>{mockDescriptionArr.slice(0, isOpen ? mockDescriptionArr.length : 50).join(" ")}{!isOpen && "..."}</p>
        {!!isOpen &&
            <div className='border-t-2 border-b-2 py-4 my-5'>
                ...
                <p className='text-gray-400 mb-1 font-semibold'>
                    Изображение и звук.
                    <span className='text-gray-500 font-normal'> Фактическое качество зависит от устройства и ограничений правообладателя.</span>
                </p>
                <ul className='flex gap-x-1'>
                    <li className='px-2 py-0.5 text-[12px] font-bold rounded py-0 bg-[rgba(255,255,255,.16)] text-white'>FullHD</li>
                    <li className='px-2 py-0.5 text-[12px] font-bold rounded py-0 bg-[rgba(255,255,255,.16)] text-white'>HD</li>
                    <li className='px-2 py-0.5 text-[12px] font-bold rounded py-0 bg-[rgba(255,255,255,.16)] text-white'>1080</li>
                    <li className='px-2 py-0.5 text-[12px] font-bold rounded py-0 bg-[rgba(255,255,255,.16)] text-white'>720</li>
                    <li className='px-2 py-0.5 text-[12px] font-bold rounded py-0 bg-[rgba(255,255,255,.16)] text-white'>5.1</li>
                </ul>
            </div>
        }
        <button

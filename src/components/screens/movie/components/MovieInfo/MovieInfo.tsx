  ...
  return (
      <div className={`flex flex-col ${variant === 'full' ? 'w-[465px]' : 'w-full'} `}>
        <div className={`${variant === 'full' && "max-[1050px]:hidden"}`}>
          <h1 className={`font-bold text-white mb-4 ${variant === 'full' ? 'text-center text-4xl' : 'text-[50px] max-[600px]:text-[32px]'}`}>Зеленая книга (Фильм 2018)</h1>
          ...
          <ul className='flex items-center gap-2 text-[14px] text-gray-400 font-semibold mx-auto mb-1'>
            ...
            <li className='transition-colors duration-300 hover:text-white cursor-pointer'>Комедия</li>
            <li className='w-[2px] h-[2px] bg-white rounded-full'></li>
            <li className='transition-colors duration-300 hover:text-white cursor-pointer'>Биография</li>
            <li className='w-[2px] h-[2px] bg-white rounded-full'></li>
          ...
          <ul className='flex items-center gap-2 text-[14px] text-gray-400 font-semibold mx-auto'>
            <li><p className='text-white font-bold text-[12px] rounded px-3 py-0.5 bg-[rgba(255,255,255,.16)]'>FullHD</p></li>
